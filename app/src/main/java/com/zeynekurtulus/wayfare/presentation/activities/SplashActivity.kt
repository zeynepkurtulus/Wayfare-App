...
class SplashActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // ====== TESTING MODE: Currently set to SIGN-UP FLOW ======
        sharedPreferencesManager.clearUserSession()  // 🔓 ACTIVE: Will go to Sign-Up screen
        // 💡 To test LOGGED-IN flow: Comment out the line above with //
        // ==========================================================
    ...
    private fun navigateToNextScreen() {
        ...
        // 📋 NAVIGATION LOGIC:
        // ✅ Logged in: SplashActivity → MainActivity (Home with bottom nav)
        // ❌ Not logged in: SplashActivity → LoginActivity → [SignUpActivity → OtpVerificationActivity] → MainActivity
